      ...
      <div className="App">
       <div className='game-container'>
        <div className='dice-container'>
         <div className={this.state.held[0] ? 'held' : ''} onClick={()=>this.toggleDie(0)}> <Die number={this.state.dice[0]} /></div>
         <div className={this.state.held[1] ? 'held' : ''} onClick={()=>this.toggleDie(1)}> <Die number={this.state.dice[1]} /></div>
         <div className={this.state.held[2] ? 'held' : ''} onClick={()=>this.toggleDie(2)}> <Die number={this.state.dice[2]} /></div>
         <div className={this.state.held[3] ? 'held' : ''} onClick={()=>this.toggleDie(3)}> <Die number={this.state.dice[3]} /></div>
         <div className={this.state.held[4] ? 'held' : ''} onClick={()=>this.toggleDie(4)}> <Die number={this.state.dice[4]} /></div>
      </div>
